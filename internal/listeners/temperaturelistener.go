...
func NewTemperatureListener(listenerName string, mqttUrl *url.URL, store *stores.InfluxStore) (*TemperatureListener, error) {
...
func (l TemperatureListener) Connect() error {
