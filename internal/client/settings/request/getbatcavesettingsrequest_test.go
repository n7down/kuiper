...
func Test_Get_Bat_Cave_Settings_Request_Validate(t *testing.T) {
	testCases := []struct {
		name           string
		req            GetBatCaveSettingsRequest
		expectedErrors int
	}{
		{
...
func Test_Get_Bat_Cave_Settings_Request_Validate_When_Device_ID_Is_Not_Valid(t *testing.T) {
	testCases := []struct {
		name           string
		req            GetBatCaveSettingsRequest
